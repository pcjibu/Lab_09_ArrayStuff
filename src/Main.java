...
public class Main {
    public static void main(String[] args) {
        ...
        int userValue = SafeInput.getRangedInt(in, "Please enter an integer value [1 - 100] ", 1, 100);
        int counter = 0;
        ...
        int userNumber = SafeInput.getRangedInt(in, "\nPlease enter a new integer value [1 - 100] ", 1, 100);
